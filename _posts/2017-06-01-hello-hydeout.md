...
The **[workshop programme]({{ '/category/program' | relative_url }})** (schedule, keynote slot, and paper session) is published on the Program page.
...
- Edge AI solutions, models, and applications for IoT applications to optimize or enable applications in which time plays a significant role.
